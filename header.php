...
<head>
  ...
  <title>Online PsychoTherapy</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="images/psy.png" rel="icon">
...
<body>
  ...
  <!-- <header id="header" class="fixed-top"> -->
    <div class="container d-flex align-items-center">
      ...
      <a href="index.html" class="logo me-auto"><img src="images/psy.png" alt="" ></a>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="register_therapist.php?#register_therapist">Register as Therapist</a></li>
        </ul>
