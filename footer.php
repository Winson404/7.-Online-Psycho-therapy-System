 <!-- ======= Footer ======= -->
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <p>
                PHLIPPINES<br>
                LOWER TAWAY IPIL ZAMBOANGA SIBUGAY<br><br>
                <strong>Phone:</strong>+639751337413<br>
                <strong>Email:</strong> onlinepsychotherapy@yahoo.com<br>
              </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Online PsychoTherapy</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">ARCHIE PAGENTE</a>
      </div>
    </div>
  </footer><!-- End Footer -->
